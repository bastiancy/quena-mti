...
var ProductoDetailComponent = (function () {
    function ProductoDetailComponent(productoService, route, location) {
    ...
    ProductoDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .switchMap(function (params) { return _this.productoService.getProducto(params['id']); })
            .subscribe(function (producto) { return _this.producto = producto; });
    };
    ProductoDetailComponent.prototype.goBack = function () {
        this.location.back();
    };
    ProductoDetailComponent.prototype.save = function () {
        var _this = this;
...
exports.ProductoDetailComponent = ProductoDetailComponent;
